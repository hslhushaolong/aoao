...
class TeamBuildDetail extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentDidMount() {
    ...
    this.props.dispatch({
      ...
      payload: {
        order_id,
        permission_id: Modules.ModuleFinanceApplyTeamBuildDetail.id,
      },
    });
  }
...
export default connect(mapStateToProps)(TeamBuildDetail);
