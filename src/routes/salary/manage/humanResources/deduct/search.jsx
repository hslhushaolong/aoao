...
class Search extends Component {
  ...
  onReset = () => {
    ...
    const defaultParam = { page: 1, limit: 30, fund_id: KnightSalaryType.personnalDeduct, sort: -1, permission_id: Modules.ModuleSalaryManageKnightDeduct.id };
    const params = {
  ...
  onSearch = (values) => {
    ...
    const params = {
      ...
      page: 1, // 页码
      limit: 30, // 条数
      createdStartDate: dot.has(dateRange, '0') ? moment(values.dateRange[0]).format('YYYY-MM-DD') : '', // 创建开始时间
      createdEndDate: dot.has(dateRange, '1') ? moment(values.dateRange[1]).format('YYYY-MM-DD') : '', // 创建结束时间
    };
