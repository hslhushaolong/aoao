...
import { KnightSalaryApproveState, CutEventType, KnightSalaryType, renderReplaceAmount } from '../../../../../../../application/define';
...
class Audit extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      selectedRows: [], // 选中的数据
      date: props.location.query.month, // 日期
      sort: -1, // 排序
  ...
  onClickSubmit = () => {
    ...
    if (stateSum) {
      ...
      this.setState({
        ...
        modalState: true, // 同意
        stateSum, // 选中数据的长度
        amount: amount.toFixed(2), // 选中数据的价格，保留小数点后两位
