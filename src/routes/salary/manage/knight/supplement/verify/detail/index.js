...
import { KnightSalaryApproveState, FillingEventType, KnightSalaryType, renderReplaceAmount } from '../../../../../../../application/define';
...
class Audit extends Component {
  ...
  componentWillReceiveProps=(nextProps) => {
    this.setState({
      summaryDataSource: dot.get(nextProps, 'salaryModel.knightFillingMessage.collect_items', []), // 汇总列表
