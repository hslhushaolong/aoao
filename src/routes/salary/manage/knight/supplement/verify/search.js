    ...
    const items = [
      ...
      },
      {
        ...
        form: form => (form.getFieldDecorator('mouthRangeL')(
          <MonthPicker style={{ width: '100%' }} onChange={this.onChangeMonthStart} disabledDate={this.onDisabledStartMouth} placeholder="请选择补款月份" />,
        )),
      },
      {
        label: '',
        form: form => (form.getFieldDecorator('mouthRangeR')(
          <MonthPicker style={{ width: '100%' }} onChange={this.onChangeMonthEnd} disabledDate={this.onDisabledEndMouth} placeholder="请选择补款月份" />,
        )),
      },
    ];
