...
class IndexPage extends Component {
  ...
  onSearch = (params) => {
    ...
    const tempParams = {
      ...
      fund_id: KnightSalaryType.fillingMoney, // 补款
      page: params.page, // 页码
      limit: 30, // 每页条数
      sort: -1, // 排序
      ...
      submit_state: params.complateState && Number(params.complateState), // 完成状态
  ...
  onShowTaskCreateModal = () => {
    this.props.dispatch({
      ...
      payload: {
        hash: '/Salary/Manage/Knight/Supplement/Create', // 新建骑士扣款路由
      },
    });
  }
  ...
  renderContent = () => {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (text, record, index) => {
          return (
            <div>
              <Link target="_blank" to={`Salary/Manage/Knight/Supplement/Detail?id=${record._id}&detail_list=${record.detail_list}&state=${record.state}`}>查看</Link>
    ...
    return (
      <CoreContent>
        ...
        {/* 是否有新建骑士补款按钮权限 */}
        { Operate.canOperateSalaryFillingMoneyCreateButton() ?
          <div style={{ marginBottom: '10px' }} >
            <Button type="primary" style={{ marginRight: '10px' }} onClick={this.onShowTaskCreateModal}>新建骑士补款</Button>
          </div> : ''
        }
