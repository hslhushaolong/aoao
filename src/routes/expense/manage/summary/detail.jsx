...
// 薪资提交页面相关
import SummaryDetailSalary from './detail/salary';
// 租房提交页面相关
import SummaryDetailRent from './detail/rent';
// 报销提交页面相关
import SummaryDetailRefund from './detail/refund';
...
class Index extends Component {
  ...
  renderContent = () => {
    ...
    if (expenseType === ExpenseType.rent) {
      return <SummaryDetailRent summaryId={summaryId} />;
    }

    // 报销相关页面
    if (expenseType === ExpenseType.refund) {
      return <SummaryDetailRefund summaryId={summaryId} />;
    }

    // 薪资相关页面
    if (expenseType === ExpenseType.salary) {
      return <SummaryDetailSalary summaryId={summaryId} />;
    }
